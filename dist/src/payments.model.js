    ...
    function Payments(secretsString) {
        ...
        this.scan = function () {
            ...
            return __awaiter(_this, __spreadArray([], args_1, true), void 0, function (params, query) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, (0, paginateModel_1.paginateModel)(this.Payment, 'scan', params, query)];
                        case 1: return [2 /*return*/, _b.sent()];
                    }
                });
            });
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, paginateModel_1.paginateModel)(this.Payment, 'find', key, query, {
                                    index: 'gs4',
                                    follow: true,
                                })];
                        case 1: return [2 /*return*/, _b.sent()];
