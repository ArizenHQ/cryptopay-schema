...
var DocumentOrder = /** @class */ (function () {
    function DocumentOrder(secretsString) {
        ...
        this.scan = function () {
            ...
            return __awaiter(_this, __spreadArray([], args_1, true), void 0, function (params, query) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, (0, paginateModel_1.paginateModel)(this.DocumentOrder, 'scan', params, query)];
                        case 1: return [2 /*return*/, _b.sent()];
                    }
                });
            });
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, paginateModel_1.paginateModel)(this.DocumentOrder, 'find', key, query, {
                                    index: 'gs4',
                                    follow: true,
                                })];
                        case 1: return [2 /*return*/, _b.sent()];
    ...
    var _a;
    _a = DocumentOrder;
    DocumentOrder.init = function () { return __awaiter(void 0, void 0, void 0, function () {
        var secretsString;
...
exports.default = DocumentOrder;
//# sourceMappingURL=documents.order.model.js.map