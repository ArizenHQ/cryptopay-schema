...
var RefreshToken = /** @class */ (function () {
    function RefreshToken(secretsString) {
        ...
        this.revokeAll = function (userId) { return __awaiter(_this, void 0, void 0, function () {
            var tokens;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.RefreshToken.find({ userId: userId })];
                    case 1:
                        tokens = _b.sent();
                        return [2 /*return*/, Promise.all(tokens.map(function (t) { return t.update({ revoked: true }); }))];
                }
            });
        }); };
    ...
    var _a;
    _a = RefreshToken;
    RefreshToken.init = function () { return __awaiter(void 0, void 0, void 0, function () {
        var secretsString;
