...
var PaymentLinks = /** @class */ (function () {
    function PaymentLinks(secretsString) {
        ...
        this.scan = function () {
            ...
            return __awaiter(_this, __spreadArray([], args_1, true), void 0, function (params, query) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, (0, paginateModel_1.paginateModel)(this.Kyt, 'scan', params, query)];
        ...
        this.findByOrderId = function (orderId) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.PaymentLink.find({ orderId: orderId }, { index: "gs2", follow: true })];
                    case 1: return [2 /*return*/, _b.sent()];
                }
            });
        }); };
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, paginateModel_1.paginateModel)(this.PaymentLink, 'find', key, query, {
                                    index: 'gs3',
                                    follow: true,
                                })];
                        case 1: return [2 /*return*/, _b.sent()];
    ...
    var _a;
    _a = PaymentLinks;
    PaymentLinks.init = function () { return __awaiter(void 0, void 0, void 0, function () {
        var secretsString;
...
//# sourceMappingURL=paymentLink.model.js.map