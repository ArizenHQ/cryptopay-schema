...
var Conversions = /** @class */ (function () {
    function Conversions(secretsString) {
        ...
        this.scan = function (params, query) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.Conversion.scan(params, query)];
                    case 1: return [2 /*return*/, _b.sent()];
                }
            });
        }); };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.Conversion.find(key, { index: "gs1", follow: true }, query)];
                    case 1: return [2 /*return*/, _b.sent()];
                }
            });
        }); };
    ...
    var _a;
    _a = Conversions;
    Conversions.init = function () { return __awaiter(void 0, void 0, void 0, function () {
        var secretsString;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, new Conversions(secretsString)];
            }
        });
    }); };
    return Conversions;
...
//# sourceMappingURL=conversions.model.js.map