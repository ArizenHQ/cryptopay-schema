...
exports.GasStationStatements = void 0;
...
var GasStationStatements = /** @class */ (function () {
    function GasStationStatements(secretsString) {
        ...
        this.insert = function (data) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.Project.get({ id: data.projectId }, { index: "gs2", follow: true })];
                    case 1:
                        project = _b.sent();
                        if (!project)
                    ...
                    case 3:
                        error_1 = _b.sent();
                        throw new Error("Error during insert GasStationStatement: ".concat(error_1));
        ...
        this.findById = function (id) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.GasStationStatement.get({ id: id }, { index: "gs1", follow: true })];
                    case 1: return [2 /*return*/, _b.sent()];
                }
            });
        }); };
        this.findByProjectAndMonth = function (projectId, month) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.GasStationStatement.get({ gs3sk: "gasStationStatement#".concat(month, "#").concat(projectId) }, { index: "gs3", follow: true })];
                    case 1: return [2 /*return*/, _b.sent()];
                }
            });
        }); };
        this.listByProject = function (projectId_1) {
            var args_1 = [];
            for (var _i = 1; _i < arguments.length; _i++) {
                args_1[_i - 1] = arguments[_i];
            }
            return __awaiter(_this, __spreadArray([projectId_1], args_1, true), void 0, function (projectId, query) {
                if (query === void 0) { query = {}; }
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, (0, paginateModel_1.paginateModel)(this.GasStationStatement, "find", { gs2sk: "gasStationStatement#".concat(projectId) }, query, { index: "gs2", follow: true })];
                        case 1: return [2 /*return*/, _b.sent()];
                    }
                });
            });
        };
        this.listByMonth = function (month_1) {
            var args_1 = [];
            for (var _i = 1; _i < arguments.length; _i++) {
                args_1[_i - 1] = arguments[_i];
            }
            return __awaiter(_this, __spreadArray([month_1], args_1, true), void 0, function (month, query) {
                if (query === void 0) { query = {}; }
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, (0, paginateModel_1.paginateModel)(this.GasStationStatement, "find", { gs3sk: { begins: "gasStationStatement#".concat(month) } }, query, { index: "gs3", follow: true })];
                        case 1: return [2 /*return*/, _b.sent()];
                    }
                });
            });
    ...
    var _a;
    _a = GasStationStatements;
    GasStationStatements.init = function () { return __awaiter(void 0, void 0, void 0, function () {
        var secretsString;
    ...
    return GasStationStatements;
}());
exports.GasStationStatements = GasStationStatements;
exports.default = GasStationStatements;
//# sourceMappingURL=gasStationStatements.model.js.map