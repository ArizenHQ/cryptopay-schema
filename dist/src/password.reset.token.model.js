...
var PasswordResetToken = /** @class */ (function () {
    function PasswordResetToken(secretsString) {
        var _this = this;
        ...
        this.findByToken = function (token) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.PasswordResetToken.get({ token: token }, { index: "gs1", follow: true })];
                    case 1: return [2 /*return*/, _b.sent()];
                }
            });
        }); };
        this.markUsed = function (token) { return __awaiter(_this, void 0, void 0, function () {
            var item;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        item.used = true;
                        return [4 /*yield*/, this.PasswordResetToken.update(item, { return: "get" })];
        ...
        this.deleteExpired = function () {
            ...
            return __awaiter(_this, __spreadArray([], args_1, true), void 0, function (now) {
                var expired;
                if (now === void 0) { now = new Date(); }
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.PasswordResetToken.find({ gs1pk: "resetToken#" }, {
                                where: "expiresAt < :now",
                                values: { now: now },
                                index: "gs1",
                            })];
                        case 1:
                            expired = _b.sent();
                            return [2 /*return*/, Promise.all(expired.map(function (t) { return t.remove(); }))];
                    }
                });
            });
        };
    ...
    PasswordResetToken.init = function () { return __awaiter(void 0, void 0, void 0, function () {
        var secretsString;
