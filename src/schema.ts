...
const Match = {
  ...
  name: /^[a-z0-9 ,.'-]+$/i,
  address: /[a-z0-9 ,.-]+$/,
  cryptoEVMAddress: /^(0x)?[0-9a-f]{40}$/i,
  zip: /^\d{5}(?:[-\s]\d{4})?$/,
...
const Schema = {
  ...
  models: {
        ...
        schema: {
          ...
          gasStation: {
            ...
            schema: {
              ...
              allowedAddresses: { type: Array, default: [] },
              tokenPriceOverrides: { type: Object, default: {} },
              treasuryWalletId: { type: String },
            },
          },
        },
      },
    ...
    PaymentLink: {
      pk: { type: String, value: "account#${accountId}" },
      sk: { type: String, value: "paymentLink#${id}" },
      id: { type: String, generate: "uuid", validate: Match.uuid },
      accountId: { type: String, required: true },
      orderId: { type: String },
      ...
      ulid: { type: String, generate: "ulid" },
      gs1pk: { type: String, value: "paymentLink#" },
      gs1sk: { type: String, value: "paymentLink#${id}" },
      gs2sk: { type: String, value: "paymentLink#${orderId}" },
      gs3sk: { type: String, value: "paymentLink#${ulid}" },
      gs4sk: { type: String, value: "paymentLink#${cryptoOrder}" },
      gs5pk: { type: String, default: "standard#paymentLink" },
      gs5sk: { type: String, value: "paymentLink#${projectId}" },
    },
    DocumentOrder: {
      pk: { type: String, value: "account#${accountId}" },
    ...
    GasStation: {
      ...
      fees: { type: Number },
      quoteEurAtSendTime: { type: Number },
      commissionRate: { type: Number },
      feeAmountEur: { type: Number },
      ...
      travelRuleOwnerInfos: { type: Object, default: {} },
      travelRuleHost: { type: String },
      travelRuleHostType: { type: String, enum: ["platform", "wallet", "unknown"] },
      ulid: { type: String, generate: "ulid" },
      gs1pk: { type: String, value: "gasStation#" },
      gs1sk: { type: String, value: "gasStation#${id}" },
      gs2sk: { type: String, value: "gasStation#${projectId}" },
      gs3sk: { type: String, value: "gasStation#${statusOrder}" },
    ...
    GasStationStatement: {
      pk: { type: String, value: "account#${accountId}" },
      sk: { type: String, value: "gasStationStatement#${id}" },
      id: { type: String, generate: "ulid" },
      accountId: { type: String, required: true },
      projectId: { type: String, required: true },
      month: { type: String, required: true },
      lineItems: { type: Array, default: [] },
      totalFeeEur: { type: Number },
      status: {
        type: String,
        default: "DRAFT",
      ...
      gs1sk: { type: String, value: "gasStationStatement#${id}" },
      gs2sk: { type: String, value: "gasStationStatement#${projectId}" },
      gs3sk: { type: String, value: "gasStationStatement#${month}#${projectId}" },
      gs4sk: { type: String, value: "gasStationStatement#${ulid}" },
    },
    AuditLog: {
      pk: { type: String, value: "account#${accountId}" },
      sk: { type: String, value: "auditLog#${id}" },
      id: { type: String, generate: "ulid" },
      accountId: { type: String, required: true },
      ...
      ulid: { type: String, generate: "ulid" },
      gs1pk: { type: String, value: "auditLog#" },
      gs1sk: { type: String, value: "auditLog#${ulid}" },
      gs5pk: { type: String, value: "auditLog#${entityType}#${entityId}" },
      gs5sk: { type: String, value: "auditLog#${at}" },
    },
    RefreshToken: {
