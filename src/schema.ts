...
const Schema = {
  ...
  models: {
    ...
    Project: {
      ...
      gs1sk: { type: String, value: 'project#${projectCode}' },
      gs2sk: { type: String, value: 'project#${id}' },
      gs3sk: { type: String, value: 'project#${apiKey}' },
      gs4sk: { type: String, value: 'project#${name}#${id}#${projectCode}' },
    },
    Order: {
      pk: { type: String, value: 'account#${accountId}' },
      ...
      gs2sk: { type: String, value: 'order#${typeOrder}#${projectCode}' },
      gs3sk: { type: String, value: 'order#${success}' },
      gs4sk: { type: String, value: 'order#${id}#${typeOrder}#${projectCode}#${success}#${tx_hash}' },
    },
    Payment: {
      pk: { type: String, value: 'account#${accountId}' },
